...
mipsinstruction decode(int value)
{
	...
	int posCheck = (value & (0x00008000))>>15 ; //will give the fifteenth position and determine if I orR 
...
//	  instr.immediate = ((value & (0x0000FFFF)) ^ 0x0000FFFF)+1   ; //should be the next 5 bits (treating it as shmt) 
	  instr.immediate = -1; 
